...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(series.title) FROM series INNER JOIN characters ON series.author_id = characters.author_id WHERE characters.species = 'human' GROUP BY series.title ORDER BY COUNT(series.title) DESC"
end
